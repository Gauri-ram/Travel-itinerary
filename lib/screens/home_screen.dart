  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child:
        Column(children: [
          HomeHeader(height: 400, imageAsset: 'assets/travel_1.jpg', title1: 'Travellers Itinerary!',title2: 'Discover Your Next Adventure!',),
          SizedBox(height: 5),
          PopularPlaces(username: widget.username,),
        ]),
      ),
    );
  }
